            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('create')?'active':'' }}"  href="/poli/create" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('create')?'active':'' }}"  href="/pasien/create" aria-expanded="false">
                                <span>
                                    <i class="ti ti-plus"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('laporan_pasien')?'active':'' }}"  href="/laporan_pasien/create" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link {{ request()->is('laporan_daftar')?'active':'' }}"  href="/laporan_daftar/create" aria-expanded="false">
                                <span>
                                    <i class="ti ti-user"></i>
                                </span>
